<%@ page language="java" contentType="text/html; charset=UTF-8"
  pageEncoding="UTF-8"
  import="java.util.List, java.util.ArrayList, model.entity.SectionBean, model.entity.EmployeeBean"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>従業員情報管理システム - 従業員編集</title>
</head>
<body>
  <h1>従業員編集</h1>
  <%
  ...
  <form action="#" method="post">
    ...
    <select name="section-code">
      ...
      %>
      <% if ((section.getSectionName()).equals(employee.getSectionName())) { %>
        <option selected value="<%=section.getSectionCode()%>"><%=section.getSectionName()%></option>
      <% } else { %>
